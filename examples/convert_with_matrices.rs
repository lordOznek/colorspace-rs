...
// This example shows how to convert between color spaces step-by-step by building
// and using the necessary matrices directly
fn main() {
    ...
    let xf_xyz_to_adobe_rgb = xyz_to_rgb_matrix(srgb.white, adobe_rgb);
    let xf_xyz_to_alexa_wide = xyz_to_rgb_matrix(srgb.white, alexa_wide);
    let xf_xyz_to_dci_p3 = xyz_to_rgb_matrix(srgb.white, dci_p3);
